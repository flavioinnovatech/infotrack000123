...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Equipment.simcard'
        db.add_column('equipments_equipment', 'simcard', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Equipment.simcard'
        db.delete_column('equipments_equipment', 'simcard')
