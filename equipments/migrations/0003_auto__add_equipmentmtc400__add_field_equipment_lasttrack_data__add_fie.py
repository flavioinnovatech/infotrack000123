...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'EquipmentMTC400'
        db.create_table('equipments_equipmentmtc400', (
            ...
            ('ignition', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('output1', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('panic', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('lastupdate', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('equipments', ['EquipmentMTC400'])

        # Adding field 'Equipment.lasttrack_data'
        db.add_column('equipments_equipment', 'lasttrack_data', self.gf('django.db.models.fields.IntegerField')(default=-1), keep_default=False)

        # Adding field 'Equipment.lasttrack_update'
        db.add_column('equipments_equipment', 'lasttrack_update', self.gf('django.db.models.fields.IntegerField')(default=-1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'EquipmentMTC400'
        db.delete_table('equipments_equipmentmtc400')

        # Deleting field 'Equipment.lasttrack_data'
        db.delete_column('equipments_equipment', 'lasttrack_data')

        # Deleting field 'Equipment.lasttrack_update'
        db.delete_column('equipments_equipment', 'lasttrack_update')
    ...
    models = {
        ...
        'equipments.availablefields': {
            ...
            'custom_fields': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['equipments.CustomField']", 'symmetrical': 'False'}),
        ...
        'equipments.equipmentmtc400': {
            'Meta': {'object_name': 'EquipmentMTC400'},
            'equipment': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['equipments.Equipment']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ignition': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            'lastupdate': ('django.db.models.fields.DateTimeField', [], {}),
            'output1': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            'panic': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'000017E8'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
