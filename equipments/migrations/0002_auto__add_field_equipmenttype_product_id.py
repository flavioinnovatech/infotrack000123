...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EquipmentType.product_id'
        db.add_column('equipments_equipmenttype', 'product_id', self.gf('django.db.models.fields.IntegerField')(default=41), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'EquipmentType.product_id'
        db.delete_column('equipments_equipmenttype', 'product_id')
