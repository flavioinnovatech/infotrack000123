...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Equipment.lastdriver'
        db.add_column('equipments_equipment', 'lastdriver', self.gf('django.db.models.fields.IntegerField')(default=-1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Equipment.lastdriver'
        db.delete_column('equipments_equipment', 'lastdriver')
