...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Vehicle.erased'
        db.add_column('vehicles_vehicle', 'erased', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Vehicle.erased'
        db.delete_column('vehicles_vehicle', 'erased')
