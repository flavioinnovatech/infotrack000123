...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('vehicles_vehicle', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('equipment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['equipments.Equipment'], unique=True, null=True, blank=True)),
            ('chassi', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('license_plate', self.gf('django.db.models.fields.CharField')(unique=True, max_length=10)),
            ...
            ('last_alert_date', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('threshold_time', self.gf('django.db.models.fields.FloatField')(default=5)),
        ))
        db.send_create_signal('vehicles', ['Vehicle'])

        # Adding M2M table for field system on 'Vehicle'
        db.create_table('vehicles_vehicle_system', (
        ...
        db.create_unique('vehicles_vehicle_system', ['vehicle_id', 'system_id'])


    def backwards(self, orm):
        
        # Deleting model 'Vehicle'
        db.delete_table('vehicles_vehicle')

        # Removing M2M table for field system on 'Vehicle'
        db.delete_table('vehicles_vehicle_system')
