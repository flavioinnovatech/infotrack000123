...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Vehicle.order'
        db.add_column('vehicles_vehicle', 'order', self.gf('django.db.models.fields.CharField')(default='', max_length=6), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Vehicle.order'
        db.delete_column('vehicles_vehicle', 'order')
