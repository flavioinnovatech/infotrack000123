...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'System.sessiontime'
        db.add_column('system_system', 'sessiontime', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'System.sessiontime'
        db.delete_column('system_system', 'sessiontime')
    ...
    models = {
        ...
        'system.system': {
            ...
            'sessiontime': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
