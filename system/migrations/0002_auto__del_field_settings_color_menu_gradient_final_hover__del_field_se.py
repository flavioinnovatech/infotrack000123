...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Settings.color_menu_gradient_final_hover'
        db.delete_column('system_settings', 'color_menu_gradient_final_hover')

        # Deleting field 'Settings.color_menu_gradient_inicial_hover'
        db.delete_column('system_settings', 'color_menu_gradient_inicial_hover')

        # Deleting field 'Settings.color_menu_gradient_inicial'
        db.delete_column('system_settings', 'color_menu_gradient_inicial')

        # Deleting field 'Settings.color_menu_gradient_final'
        db.delete_column('system_settings', 'color_menu_gradient_final')

        # Adding field 'Settings.color1'
        db.add_column('system_settings', 'color1', self.gf('django.db.models.fields.CharField')(default='#7a7a7a', max_length=50), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Settings.color_menu_gradient_final_hover'
        db.add_column('system_settings', 'color_menu_gradient_final_hover', self.gf('django.db.models.fields.CharField')(default='#a1a1a1', max_length=50), keep_default=False)

        # Adding field 'Settings.color_menu_gradient_inicial_hover'
        db.add_column('system_settings', 'color_menu_gradient_inicial_hover', self.gf('django.db.models.fields.CharField')(default='#ebebeb', max_length=50), keep_default=False)

        # Adding field 'Settings.color_menu_gradient_inicial'
        db.add_column('system_settings', 'color_menu_gradient_inicial', self.gf('django.db.models.fields.CharField')(default='#a9a9a9', max_length=50), keep_default=False)

        # Adding field 'Settings.color_menu_gradient_final'
        db.add_column('system_settings', 'color_menu_gradient_final', self.gf('django.db.models.fields.CharField')(default='#7a7a7a', max_length=50), keep_default=False)

        # Deleting field 'Settings.color1'
        db.delete_column('system_settings', 'color1')
