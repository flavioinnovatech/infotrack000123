...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Settings.color2'
        db.add_column('system_settings', 'color2', self.gf('django.db.models.fields.CharField')(default='#ebebeb', max_length=50), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Settings.color2'
        db.delete_column('system_settings', 'color2')
