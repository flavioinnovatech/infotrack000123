...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'System.sms_count'
        db.add_column('system_system', 'sms_count', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'System.can_sms'
        db.add_column('system_system', 'can_sms', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Settings.map_multspectral'
        db.delete_column('system_settings', 'map_multspectral')

        # Deleting field 'Settings.map_google'
        db.delete_column('system_settings', 'map_google')

        # Deleting field 'Settings.map_maplink'
        db.delete_column('system_settings', 'map_maplink')


    def backwards(self, orm):
        
        # Deleting field 'System.sms_count'
        db.delete_column('system_system', 'sms_count')

        # Deleting field 'System.can_sms'
        db.delete_column('system_system', 'can_sms')

        # Adding field 'Settings.map_multspectral'
        db.add_column('system_settings', 'map_multspectral', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Settings.map_google'
        db.add_column('system_settings', 'map_google', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Settings.map_maplink'
        db.add_column('system_settings', 'map_maplink', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
