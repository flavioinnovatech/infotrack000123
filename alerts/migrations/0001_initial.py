...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('alerts_alert', (
            ...
            ('receive_email', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('receive_sms', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('receive_popup', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('trigger', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['equipments.CustomFieldName'], null=True)),
            ('state', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('geofence', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['geofence.Geofence'], null=True, blank=True)),
            ('linear_limit', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=0, blank=True)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('alerts', ['Alert'])

        # Adding M2M table for field vehicle on 'Alert'
        db.create_table('alerts_alert_vehicle', (
        ...
        db.create_unique('alerts_alert_vehicle', ['alert_id', 'vehicle_id'])

        # Adding M2M table for field destinataries on 'Alert'
        db.create_table('alerts_alert_destinataries', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('alert', models.ForeignKey(orm['alerts.alert'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('alerts_alert_destinataries', ['alert_id', 'user_id'])

        # Adding model 'Popup'
        db.create_table('alerts_popup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('alerts', ['Popup'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field vehicle on 'Alert'
        db.delete_table('alerts_alert_vehicle')

        # Removing M2M table for field destinataries on 'Alert'
        db.delete_table('alerts_alert_destinataries')

        # Deleting model 'Popup'
        db.delete_table('alerts_popup')
