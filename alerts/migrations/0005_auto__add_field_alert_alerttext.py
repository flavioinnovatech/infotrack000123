...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Alert.alerttext'
        db.add_column('alerts_alert', 'alerttext', self.gf('django.db.models.fields.CharField')(max_length=160, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Alert.alerttext'
        db.delete_column('alerts_alert', 'alerttext')
