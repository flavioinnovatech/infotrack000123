...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Popup.system'
        db.add_column('alerts_popup', 'system', self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['system.System']), keep_default=False)
