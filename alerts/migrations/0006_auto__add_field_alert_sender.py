...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Alert.sender'
        db.add_column('alerts_alert', 'sender', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Alert.sender'
        db.delete_column('alerts_alert', 'sender_id')
    ...
    models = {
        'alerts.alert': {
            ...
            'alerttext': ('django.db.models.fields.CharField', [], {'max_length': '160', 'null': 'True', 'blank': 'True'}),
            'destinataries': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'alert_destinataries'", 'symmetrical': 'False', 'to': "orm['auth.User']"}),
