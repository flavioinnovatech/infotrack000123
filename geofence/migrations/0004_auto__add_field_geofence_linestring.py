...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Geofence.linestring'
        db.add_column('geofence_geofence', 'linestring', self.gf('django.contrib.gis.db.models.fields.LineStringField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Geofence.linestring'
        db.delete_column('geofence_geofence', 'linestring')
    ...
    models = {
        ...
        'geofence.geofence': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'linestring': ('django.contrib.gis.db.models.fields.LineStringField', [], {'null': 'True'}),
