...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Geofence.polygon'
        db.alter_column('geofence_geofence', 'polygon', self.gf('django.contrib.gis.db.models.fields.PolygonField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Geofence.polygon'
        db.alter_column('geofence_geofence', 'polygon', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(null=True))
