...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Geofence.tolerance'
        db.add_column('geofence_geofence', 'tolerance', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Geofence.tolerance'
        db.delete_column('geofence_geofence', 'tolerance')
    ...
    models = {
        ...
        'geofence.geofence': {
            ...
            'tolerance': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
