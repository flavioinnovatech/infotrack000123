...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('geofence_geofence', (
        ...
        db.send_create_signal('geofence', ['Geofence'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('geofence_geofence')
    ...
    models = {
        ...
        'geofence.geoentity': {
            'Meta': {'object_name': 'GeoEntity'},
            'geofence': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['geofence.Geofence']", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lat': ('django.db.models.fields.FloatField', [], {}),
            'lng': ('django.db.models.fields.FloatField', [], {}),
            'radius': ('django.db.models.fields.FloatField', [], {}),
            'seq': ('django.db.models.fields.IntegerField', [], {'null': 'True'})
        },
        'geofence.geofence': {
