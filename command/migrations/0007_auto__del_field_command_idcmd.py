...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Command.idcmd'
        raise RuntimeError("Cannot reverse this migration. 'Command.idcmd' and its values cannot be restored.")
