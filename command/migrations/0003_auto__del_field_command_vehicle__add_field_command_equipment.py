...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Command.equipment'
        db.add_column('command_command', 'equipment', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['vehicles.Vehicle']), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Command.vehicle'
        raise RuntimeError("Cannot reverse this migration. 'Command.vehicle' and its values cannot be restored.")
