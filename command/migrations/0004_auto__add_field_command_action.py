...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Command.action'
        db.add_column('command_command', 'action', self.gf('django.db.models.fields.CharField')(default='ON', max_length=10), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Command.action'
        db.delete_column('command_command', 'action')
