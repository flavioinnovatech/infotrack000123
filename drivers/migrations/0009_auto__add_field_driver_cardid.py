...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Driver.cardid'
        db.add_column('drivers_driver', 'cardid', self.gf('django.db.models.fields.CharField')(default='FFFFFFFFFFFFFFFF', max_length=16), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Driver.cardid'
        db.delete_column('drivers_driver', 'cardid')
    ...
    models = {
        ...
        'drivers.driver': {
            ...
            'cardid': ('django.db.models.fields.CharField', [], {'default': "'FFFFFFFFFFFFFFFF'", 'max_length': '16'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'system': ('django.db.models.fields.related.ForeignKey', [], {'default': '2', 'to': "orm['system.System']"}),
            'telephone1': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'telephone2': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'vehicle': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['vehicles.Vehicle']", 'null': 'True', 'blank': 'True'})
        },
        ...
        'equipments.equipment': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lastdriver': ('django.db.models.fields.IntegerField', [], {'default': '-1'}),
            ...
            'simcard': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'system': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['system.System']", 'symmetrical': 'False'}),
