...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Driver.system'
        db.add_column('drivers_driver', 'system', self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['system.System']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Driver.system'
        db.delete_column('drivers_driver', 'system_id')
