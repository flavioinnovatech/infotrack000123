...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Driver.telephone2'
        db.alter_column('drivers_driver', 'telephone2', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))


    def backwards(self, orm):
        
        # Changing field 'Driver.telephone2'
        db.alter_column('drivers_driver', 'telephone2', self.gf('django.db.models.fields.CharField')(default=123, max_length=20))
