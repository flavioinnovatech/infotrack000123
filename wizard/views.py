...
from itrack.wizard.storage import get_storage
from itrack.wizard.storage.exceptions import NoFileStorageConfigured
from itrack.wizard.forms import ManagementForm
...
class WizardView(TemplateView):
    ...
    instance_dict = None
    condition_dict = None
    template_name = 'wizard/templates/formtools/wizard/wizard_form.html'
...
class SessionWizardView(WizardView):
    ...
    """
    storage_name = 'itrack.wizard.storage.session.SessionStorage'
...
class CookieWizardView(WizardView):
    ...
    """
    storage_name = 'itrack.wizard.storage.cookie.CookieStorage'
